...
\comment{If the new Riboglow probes demonstrate single-molecule labeling in the beta actin model system, we will attempt to image migration of transcipts of long noncoding RNA (lncRNA) from the nucleus to the cytoplasm.
...
Most known functions of lncRNA involve networking of chromatin... % TODO continue here.
...
% IDEA track lncRNA and mRNA in this cancer model? \cite{DamasSNHG5promotescolorectal2016}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
