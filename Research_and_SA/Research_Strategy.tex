...
To strike this balance, I will use a synthetic $\upbeta$-hairpin as the linker between cobalamin and the fluorophore (Fig. \ref{figure:aim1}A, Table \ref{linkers}).
...
% TODO some additional comments here on selections and the library design?
...
In the final 2-3 rounds of selection, a counterselection will be conducted to ensure orthogonality with other synthetic probes (Fig. \ref{figure:aim3}A). In this way, the probe (or probes) intended to be orthogonal to the construct under selection will wash away any riboswitches that do not bind selectively.
...
Once mutually-selective Riboglow probes are identified, they will be tested in mammalian cells to probe the localization
