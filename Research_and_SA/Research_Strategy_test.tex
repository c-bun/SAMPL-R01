% !TEX root = ./Research_Strategy_and_SA_test.tex
...
These studies will provide the first glimpse into the real-time behavior of lncRNA \textit{SNGH5} and its interacting partners. With new tools in the RNA imaging toolkit, we will be able to ask new questions about the little understood biomolecule that accounts for half of all cellular transcription. \comment{I still need to elaborate here a bit.}

%%% Local Variables: ***
%%% mode: latex ***
%%% TeX-master: "Research_Strategy_and_SA_test.tex" ***
%%% End: ***
