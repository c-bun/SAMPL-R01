...
\begin{centering}
\includegraphics[width=\textwidth]{Research_and_Specific_Aims/figures/aim1v5.pdf}
\end{centering}
\footnotesize
...
Probes containing these new fluorophores will be evaluated for fluorescence quenching as previously described, with the addition of a test for fluorophore photostability.
...
Riboglow reduces the size of the fluorescent probe by 10--100-fold (relative to the MS2 system), however, high fluorescence background and poor signal induction precluded single-molecule studies \cite{Braselmannmulticolorriboswitchbasedplatform2018}.

With the wide variety of new probe constructs developed to reduce fluorescence background (Aim 1), changes will be made to the sequence of the cobalamin riboswitch with the \comment{goal of a 500-fold fluorescence turn-on}. \textit{A directed evolution screen for fluorescence brightness will identify optimal riboswitch sequences that promote fluorescence signal induction}.
...
\begin{centering}
\includegraphics[width=\textwidth]{Research_and_Specific_Aims/figures/aim2v2.pdf}
...
I will aim to retain K\textsubscript{D} values in the nanomolar range (optimal native riboswitches bind Riboglow probes at K\textsubscript{D} = 3 nM). \comment{Low K\textsubscript{D} values will enable low substrate dosing (10-100 nM), minimizing fluorescence background. At these concentrations, a 500-fold signal turn-on will be required to resolve as few as 10-100 target RNA present in the cytosol \cite{CabiliLocalizationabundanceanalysis2015}.}
...
This is a technique that the Palmer lab has previously used successfully to test Riboglow probes \cite{Braselmannmulticolorriboswitchbasedplatform2018}.
...
Studies involving imaging of lncRNA will be carried out under the supervision of Professor John Rinn, an expert in lncRNA (see Rinn support letter). \comment{For initial studies, we chose the lncRNA \textit{SNHG5}. This 2 kilobase transcript is ideal because it localizes to the cytoplasm (where Riboglow concentration is likely highest), and has a variety of known interacting partners \cite{DamasSNHG5promotescolorectal2016}.}
...
Next, our multicomponent Riboglow platform will be used to image \textit{SNHG5} interacting with mRNA in the cytosol. \textit{SNHG5} has been shown to promote colorectal cancer survival through base pairing in the 3'-UTR of mRNA that promote tumor growth \cite{DamasSNHG5promotescolorectal2016}.
